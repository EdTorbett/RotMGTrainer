...
$(function() {
	...
	canvas.width = screen_width = 800;//window.innerWidth - 50;
	canvas.height = screen_height = 600;//window.innerHeight - 50;
		
	player = new createjs.Shape();
        player.graphics.beginFill("green").drawCircle(0, 0, 20);
        player.x = screen_width/2;
        player.y = screen_height/2;
	player_location.x = player.x;
	player_location.y = player.y;	
